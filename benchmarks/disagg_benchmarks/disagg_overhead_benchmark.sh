...
benchmark() {
  ...
  CUDA_VISIBLE_DEVICES=0 python3 \
    ...
    --kv-transfer-config \
    '{"kv_connector":"StreamConnector","kv_role":"kv_producer","kv_rank":0,"kv_parallel_size":2,"kv_buffer_size":5e9}' &
  ...
  CUDA_VISIBLE_DEVICES=1 python3 \
    ...
    --gpu-memory-utilization 0.6 \
    --kv-transfer-config \
    '{"kv_connector":"StreamConnector","kv_role":"kv_consumer","kv_rank":1,"kv_parallel_size":2,"kv_buffer_size":5e9}' &
